...

{
	...
	sql_attr_str2ordinal	= class_<?php echo $source->name."\n"; ?>
...
index <?php echo $source->name; ?>_index
{
	...
	path			= /home/moa3/dev/sphinx/foo/data/<?php echo $source->name; ?>_index
...
searchd
{
	...
	log					= /home/moa3/dev/sphinx/foo/log/searchd.log

	# query log file, all search queries are logged here
	# optional, default is empty (do not log queries)
	query_log			= /home/moa3/dev/sphinx/foo/log/query.log
	...
	# mandatory
	pid_file			= /home/moa3/dev/sphinx/foo/log/searchd.pid
